<?php 
  //Activamos el almacenamiento en el buffer
    ...
    if (!isset($_SESSION["nombre"]))
    {
      ...
      if(isset($_SESSION["idUsuario"]) && $_SESSION["Consignatarios"] == 1)
      {
?>
       <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid row">
                <div data-bind="visible: model.empresaController.gridMode()">
                    <div class="col-lg-12">
                        <h2 class="page-header">Consignatarios 
                        <a href="#" class="btn btn-success" data-bind="click: model.empresaController.nuevoC"><i class="fa fa-plus-circle"></i> Agregar</a></h2>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="text-primary"><i class="fa fa-list"></i> Lista de consignatarios</span>
                                </div>
...
<script>
        $(document).ready(function () {
            model.empresaController.initialize("C");
        });
</script>
