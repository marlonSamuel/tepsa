                                ...
                                <div data-bind="visible:model.planificacionController.showDetalle()">
                                  ...
                                  <form name="detalleForm" id="detalleForm" class="form" data-bind="with: model.planificacionController.detalle">
                                    <div class="row">
                                      <div class="form-group col-sm-2 col-md-2">
                                        ...
                                        <div class="form-group col-sm-2 col-md-2">
                                            <label for="no_bultos">Numero de bultos<span class="text-danger"> *</span></label>
                                            <input id="peso" name="no_bultos" type="number" class="form-control" data-bind="value: no_bultos"
                                                   data-error=".no_bultos" required>
                                            <span class="peso text-danger help-inline"></span>
                                        </div>
                                  ...
                                  <table class="table table-hover table-responsive table-bordered">
                                      ...
                                      <tr>
                                        ...
                                        <td class="text-right" data-bind="text: peso"></td>
                                        <td class="text-right" data-bind="text: no_bultos"></td>
                                        <td width="10%">
                                    ...
                                    <!-- /ko -->
                                    <td colspan="3"><label class="pull-right text-primary" data-bind="text: model.planificacionController.detalle.peso_bodega().toFixed(2)"></label></td>
                                    <td><label class="pull-right text-primary" data-bind="text: model.planificacionController.total_bultos()"></td>
                                      </tbody>
                                  </table>  
