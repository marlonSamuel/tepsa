<?php 
  //Activamos el almacenamiento en el buffer
    ...
    if (!isset($_SESSION["nombre"]))
    {
      ...
      if(isset($_SESSION["idUsuario"]) && $_SESSION["Productos"] == 1)
      {
?>
       <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid row">
                <div data-bind="visible: model.productoController.gridMode()">
                    <div class="col-lg-12">
                        <h2 class="page-header">Productos 
                        <a href="#" class="btn btn-success" data-bind="click: model.productoController.nuevo"><i class="fa fa-plus-circle"></i> Agregar</a></h2>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="text-primary"><i class="fa fa-list"></i> Lista de productos</span>
                                </div>
                             ...
                             <div class="table-responsive">
                                ...
                                <table id="tipoGrid" class="table table-hover">
                                        ...
                                        <tbody data-bind="dataTablesForEach : {
                                                            data: model.productoController.tipos,
    ...
    <div class="form-group"> </div>
    <div data-bind="visible: model.productoController.editMode()||model.productoController.insertMode()">

        <form name="tipoForm" id="tipoForm" class="form" data-bind="with: model.productoController.tipo">
            <div class="row">
            ...
            <div class="form-group">
                <p class="text-center">
                    ...
                    <button type="button" class="btn btn-danger" data-bind="click:  model.productoController.cancelar"><i class="fa fa-undo"></i> Cancel</button>
                </p>
            </div>
        </form>
    </div>
