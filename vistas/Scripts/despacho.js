...
model.despachoController = {
    ...
    despacho: {
     ...
     fecha: ko.observable(""),
     bultos_descargados: ko.observable("")
 },
...
asignacion: {
    ...
    no_bultos: ko.observable(""),
    bultos_descargados: ko.observable(0)
},
...
tiempoDescarga: ko.observable(""),
    ...
    map: function (despacho) {
        ...
        eDespacho.bultos_descargados(despacho.bultos_descargados);
    },
    ...
    mapAsignacion: function(asignacion){
        ...
        eAsignacion.licencia(asignacion.licencia);
        ...
        eAsignacion.no_bultos(asignacion.no_bultos);
    },
    ...
    guardar: function () {
        ...
        var bultosTotales = model.despachoController.asignacion.bultos_descargados() + parseInt(despachoParam.bultos_descargados);

        if(bultosTotales > model.despachoController.asignacion.no_bultos()){
            toastr.error("El numero de bultos sobrepasa al numero de bultos asignados a esta seccion");
            return;
        }
     ...
     */
        Despacho.ObtenerAsignacion('obtenerA',codigo,function (data){
            ...
            model.despachoController.sumarBultos(model.despachoController.asignacion.idDetalle_asignacion());
        });
    },
 ...
 sumarBultos:function(id_asignacion){
    var arrayDespachos = model.despachoController.despachos();
    model.despachoController.asignacion.bultos_descargados(0);
    var no_bultos_descargados = model.despachoController.asignacion.bultos_descargados();
    for(var i = 0; i<arrayDespachos.length; i++){
        if(arrayDespachos[i].bultos_descargados !== null){
           no_bultos_descargados = no_bultos_descargados + parseInt(arrayDespachos[i].bultos_descargados);   
        }
    }

    model.despachoController.asignacion.bultos_descargados(no_bultos_descargados);
 },
