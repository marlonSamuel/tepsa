				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div>
								<h4>No Importacion: <span class="text-info" id="import"  data-bind="text: no_importacion"></span></h4>
							</div>                       		
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-2">
									...
									<div class="col-lg-2 col-md-2">
										<h4>Licencia: <span class="text-info" id="licencia" data-bind="text: licencia"></span></h4>
									</div>                       		
						</div>
         ...
         <div data-bind="visible: model.despachoController.insertInfo()">
         	<form name="despachoForm" id="despachoForm" class="form" data-bind="with: model.despachoController.despacho" method="POST">
				<div class="row">
					...
					<div class="form-group col-sm-2 col-md-32">
					...
					<div class="form-group col-sm-2 col-md-2">
						<label for="no_bultos">Total de bultos<span class="text-danger"> *</span></label>
						<input id="bodega" name="no_bultos" type="text" class="form-control" data-bind="value: model.despachoController.asignacion.no_bultos()" readonly>
					</div>
					<div class="form-group col-sm-2 col-md-2">
						<label for="bultos_descargados">Bultos Descargados<span class="text-danger"> *</span></label>
						<input id="bultos_descargados" name="bultos_descargados" type="text" class="form-control" data-bind="value: model.despachoController.asignacion.bultos_descargados()" readonly>
					</div>
					...
					<div class="form-group col-sm-3 col-md-3">
						<label for="bultos_descargados">Bultos a descargar<span class="text-danger"> *</span></label>
						<input id="bultos_descargados" name="bultos_descargados" type="text" class="form-control" data-bind="value: bultos_descargados">
					</div>
					<div class="form-group col-sm-3 col-md-3">
...
<div id="timeDie" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div id="dialog" style="display:none">
			<div>
				<iframe id="iframe" src="http://35.192.28.125/tepsa/reportes/CodigoDes.php?idPlano=2" width="100%" height="400px"></iframe>
			</div>
		</div>
<script>
	Chrono('#chrono-a');
		...
		model.despachoController.initialize();
			...
			$(document).ready(function() {
				$('#btn_guardar').click(function() {
					var impor = $("#import").text();
					var licencia = $("#licencia").text();
					var url = "/tepsa/reportes/CodigoDes.php?idPlano="+impor+"&licencia="+licencia;
					$('#iframe').attr('src', url);
