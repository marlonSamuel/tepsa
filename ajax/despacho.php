...
$bultos_descargados=isset($_POST["bultos_descargados"])? limpiarCadena($_POST["bultos_descargados"]):"";

switch ($_GET["op"]){
	case 'guardaryeditar':
		if (empty($idDespacho)){
			$rspta=$despacho->insertar($idAsignacion,$idAlmeja,$idTolva,$codigo,$hora,$minuto,$segundo,$seccion_bodega,$fecha,$bultos_descargados,$_POST['motivo'],$_POST['horat'], $_POST['minutot'],$_POST['segundot']);
